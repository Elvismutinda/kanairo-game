% This function creates an interactive introduction for the second level
% whereby Baba and Nuru are able to interact. Pressing 'enter' key moves to the
% next line to be displayed

function [speech_end] = kanairo_intro_2
...
[y,Fs] = audioread('music/hakuna_matata.mp3');
sound(y,Fs)
...
% Dialogue lines
line{1} = 'WOW! You didn''t tell me you could throw punches like that!';
line{2} = 'Have you considered signing up for boxing?';
line{3} = 'Word''s going around that you''re the new boxing sensation in Kanairo.';

line{4} = 'HAHA. What can I say, hii ni natural talent.';
line{5} = '(Busts into laughter)';

line{6} = '(Busts into laughter)';
line{7} = 'Well all that aside, Zakayo was spotted at the park today. Don''t ask me my source.';
line{8} = 'You''ll have to go there in order to meet him.';

line{9} = 'The park of all places?';
line{10} = 'Are you sure about this?';
line{11} = 'Aren''t there lions in the park?';

line{12} = 'Well yeah, but si umesema uko na natural talent.';
line{13} = 'Go show those lions who the boss is.  (Says jockingly)';

line{14} = '(Stares in disbelief)';
